    ...
    <div class="remark-but">
      ...
      <div class="remark-box">
        <ul class="reamrk-box1">
          <li
            :class="[isShow==index?isActive:'']"
            v-for="(value,index ) in remarks[0]"
            :key="value"
            @click="box1(index)"
          >{{value}}</li>
        </ul>
        <ul class="remark-box2">
          <li
            v-for="(value,index ) in remarks[1]"
            :key="value"
            :class="[isActive1==index?isActive:'']"
            @click="box2(index)"
            class="no-coriander"
          >{{value}}</li>
          <li
            v-for="(value,index ) in remarks[2]"
            :key="value"
            class="no-onion"
            :class="[isActive2==index?isActive:'']"
            @click="box3(index)"
          >{{value}}</li>
          <li
            v-for="(value,index ) in remarks[3]"
            :key="value"
            class="vinegar"
            :class="[isActive3==index?isActive:'']"
            @click="box4(index)"
          >{{value}}</li>
          <li
            v-for="(value,index ) in remarks[4]"
            :key="value"
            class="shallot"
            :class="[isActive4==index?isActive:'']"
            @click="box5(index)"
          >{{value}}</li>
        </ul>
        <ul class="remark-box3">
          <li
            v-for="(value,index ) in remarks[5]"
            :key="value"
            class="remark-box3li"
            :class="[isShow1==index?isActive:'']"
            @click="box6(index)"
          >{{value}}</li>
        </ul>
      </div>
